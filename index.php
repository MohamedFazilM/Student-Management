...
<div class="page-wrapper">
  ...
  <div class="hero">
    <div>
      ...
      <p class="hero-sub">Manage student records efficiently — add, search, edit and track.</p>
    </div>
  ...
  <div class="stats-row">
    ...
    <div class="stat-card">
      ...
      <div class="stat-value purple"><?= $deptCount ?></div>
    </div>
    <div class="stat-card">
      <div class="stat-label">Active Records</div>
      <div class="stat-value green"><?= $totalCount ?></div>
    </div>
    <div class="stat-card">
      <div class="stat-label">Last Updated</div>
      <div class="stat-value yellow" style="font-size:1rem;margin-top:4px"><?= date('d M Y') ?></div>
    </div>
  </div>
          ...
          <tr>
            <td colspan="5">
              <div class="empty-state">
                ...
                <p>No students yet. <a href="insert.php">Add your first student →</a></p>
              </div>
            </td>
          </tr>
          <?php else: ?>
